...
Las definiciones se pueden motivar de muchas formas. Yo en particular voy a motivarla de la misma forma que lo hizo Shannon que consiste en motivar que pretendemos de m\'etrica que diga cuanta informaci\'on brinda medir una variable aleatoria y luego obtener una formula resultante en funci\'on de las probabilidades.
...
\begin{definition}
    ...
    \end{equation}
\end{definition}
Que basicamente es la cantidad de preguntas bien elegidas que necesitamos para determinar $X$ cuando el resultado es $a_i$. Adem\'as con esta definici\'on, la entrop\'ia se reduce al valor medio de la informaci\'on que obtenemos de medir la variable aleatoria.\par
